...
$allowedCategories = [
    'desktop pc hard disks',
    'desktop pc casings',
    'desktop pc motherboards',
    'desktop pc processors',
    'desktop pc rams',
    'desktop pc graphic cards',
    'desktop pc power supplies',
    'desktop pc cpu coolers',
    'desktop pc monitors',
    'desktop pc keyboards',
    'desktop pc mouse',
    'desktop pc speakers',
    'desktop pc webcams',
    ...
    'desktop pc ups',
    'desktop pc cables',
    'desktop pc mouse pads',
    'desktop pc external hdds',
    'usb flash drives',
    'ssd drives',
    'nvme drives',
];
...
<div class="container mt-4">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Desktop PC Accessories</li>
    </ol>
    </nav>
</div>

<div class="container mt-4">
    <h1>Desktop PC Accessories</h1>
