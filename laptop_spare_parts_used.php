...
$allowedCategories = [
     'laptop displays used',
    'laptop ribbons used',
    'laptop speakers used',
    'laptop wifi adaptors used',
    'laptop connectors used',
    'laptop cooling fans used',
    'laptop power jack used',
];
...
<div class="container mt-4">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Laptop Spare Parts (Used)</li>
    </ol>
    </nav>
</div>

<div class="container mt-4">
    <h1>Laptop Spare Parts (Used)</h1>
