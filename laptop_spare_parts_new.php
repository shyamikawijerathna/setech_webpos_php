...
$allowedCategories = [
    ...
    'laptop ribbons new',
    'laptop speakers new',
    'laptop wifi adaptors new',
    'laptop connectors new',
    'laptop cooling fans new',
    'laptop power jack new',
    'laptop batteries new',
];
...
<div class="container mt-4">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Laptop Spare Parts (New)</li>
    </ol>
    </nav>
</div>

<div class="container mt-4">
    <h1>Laptop Spare Parts (New)</h1>
